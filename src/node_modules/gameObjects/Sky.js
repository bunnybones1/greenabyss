...
function Sky(params) {
	...
	var sky = new SpriteSky({
		mapTexture: THREE.ImageUtils.loadTexture('assets/textures/sky-day-cycle.png'),
		// mapTexture: THREE.ImageUtils.loadTexture('assets/textures/uvTest.png'),
	});
	scene.add(sky);
...
Sky.prototype.update = function() {
	var dayPercent = Date.now() * 0.000005;
	// dayPercent = 0.49;
	...
	// this.sky.rotation.y = performance.now() * 0.003;
