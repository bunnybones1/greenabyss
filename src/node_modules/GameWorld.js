...
const GoldHornedSheep = require('gameObjects/GoldHornedSheep');
...
function GameWorld(params) {
	...
	var sheep = new GoldHornedSheep({
		followTarget: fireLight,
		testBones: true,
...
function onEnterFrame(dt) {
	...
	// this.cameraThirdPerson.position.copy(this.sheep.position);
	// this.cameraThirdPerson.position.add(new THREE.Vector3(5, 2, 5));
	// this.cameraThirdPerson.lookAt(this.sheep.position);
}
