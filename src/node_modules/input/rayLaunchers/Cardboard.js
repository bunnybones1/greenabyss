function CardboardRayLauncher(camera) {
	this.raycaster = new THREE.Raycaster();
	this.rayCoord = new THREE.Vector2(0, -0.7);
	//always 0, 0 for cardboard, but could be different for magic window.
	this.ray = this.raycaster.ray;
	this.camera = camera;
}

CardboardRayLauncher.prototype = {
...
function onSelect(e) {
	console.log('CARDBOARD ON SELECT');
}

module.exports = CardboardRayLauncher;