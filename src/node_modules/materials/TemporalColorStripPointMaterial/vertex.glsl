...
void main() {
	...
	vOffsetY = quantizedProgress * usedFramesPercentage + inverseUsedFramesPercentage + halfPixel + uvOffsetY;
	float quantizedProgress2 = quantizedProgress + frameRatio;
	vOffsetY2 = mod(quantizedProgress2, 1.0) * usedFramesPercentage + inverseUsedFramesPercentage + halfPixel + uvOffsetY;
