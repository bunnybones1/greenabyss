...
function Material(params) {
  ...
  if(params.colorFog) {
    materialParams.uniforms.fogNear = { type: 'f', value: params.fogNear };
    materialParams.uniforms.fogFar = { type: 'f', value: params.fogFar };
    materialParams.uniforms.colorFog = { type: 'c', value: params.colorFog };
    materialParams.defines.USE_FOG = true;
  }
